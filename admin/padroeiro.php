		...
		<div id="container">
			...
			<div id="content">
				<div id="pagina"> 
					...
					<a href="padroeiro_cad.php"> <img src="css/img/cadastrar.png" style="margin-top: 10px;"/></a>
				</div>
				<br clear="all" />
				<table id="consulta">
					<thead>
					...
					if($busca=="ok"){
						while($query = @mysql_fetch_array($execute_query)){
							if($cont%2==0){ 
								...
								<td style="text-align: left;"><?=$query['pad_titulo']?></td>
								<td><a href="padroeiro_cad.php?param=<?=$query['pad_id']?>"><img src="css/img/editar.png" /></a> </td>
							</tr>
					<?php $cont++; }
					}else{?>
						<tr>
