<?php
	...
	$busca="";
	$SQL = "SELECT * FROM videos ORDER BY vid_data DESC";
	...
	<body>
		<div id="container">
			...
			<div id="content">
				<div id="pagina"> 
					GERENCIAR VÍDEOS<br />
					<a href="videos_cad.php"> <img src="css/img/cadastrar.png" style="margin-top: 10px;"/></a>
				</div>
				<br clear="all" />
				<table id="consulta">
					<thead>
					...
					if($busca=="ok"){
						while($query = @mysql_fetch_array($execute_query)){
							$separador = explode("-", $query['vid_data']);
							...
							if($cont%2==0){ 
								...
								<td style="text-align: left;"><?=$query['vid_titulo']?></td>
								<td><?=$data?></td>
								<td><a href="videos_cad.php?param=<?=$query['vid_id']?>"><img src="css/img/editar.png" /></a> </td>
							</tr>
					<?php $cont++; }
					}else{?>
						<tr>
