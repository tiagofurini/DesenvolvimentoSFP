<?php
	...
	$busca="";
	$SQL = "SELECT * FROM eventos ORDER BY eve_data";
		...
		<div id="container">
			...
			<div id="content">
				<div id="pagina"> 
					...
					<a href="eventos_cad.php"> <img src="css/img/cadastrar.png" style="margin-top: 10px;"/></a>
				</div>
				<br clear="all" />
				<table id="consulta">
					<thead>
					...
					if($busca=="ok"){
						while($query = @mysql_fetch_array($execute_query)){
							$separador = explode("-", $query['eve_data']);
							...
							if($cont%2==0){ 
								...
								<td style="text-align: left;"><?=$query['eve_titulo']?></td>
								<td><?=$data?></td>
								<td><a href="eventos_cad.php?param=<?=$query['eve_id']?>"><img src="css/img/editar.png" /></a> </td>
							</tr>
					<?php $cont++; }
					}else{?>
						<tr>
