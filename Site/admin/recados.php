<?php
	...
	$busca="";
	$SQL = "SELECT * FROM recados ORDER BY rec_data DESC";
		...
		<div id="container">
			...
			<div id="content">
				<div id="pagina"> 
					...
					<a href="recados_cad.php"> <img src="css/img/cadastrar.png" style="margin-top: 10px;"/></a>
				</div>
				<br clear="all" />
				<table id="consulta">
					<thead>
					...
					if($busca=="ok"){
						while($query = @mysql_fetch_array($execute_query)){
							$separador = explode("-", $query['rec_data']);
							...
							if($cont%2==0){ 
								...
								<td style="text-align: left;"><?=$query['rec_titulo']?></td>
								<td><?=$data?></td>
								<td><a href="recados_cad.php?param=<?=$query['rec_id']?>"><img src="css/img/editar.png" /></a> </td>
							</tr>
					<?php $cont++; }
					}else{?>
						<tr>
